...
export class TpexScraperService implements OnApplicationBootstrap {
    ...
    async fetchInstInvestorsTrades(date: string) {
        ...
        return {
            ...
            foreignDealersSell, //外資自營商賣出金額
            foreignDealersNetBuySell, //外資自營商買賣超
            foreignInvestorsBuy, //外資合計買進金額
            foreignInvestorsSell, //外資合計賣出金額
            foreignInvestorsNetBuySell, //外資合計買賣超
            sitcBuy, //投信買進金額
            sitcSell, //投信賣出金額
            sitcNetBuySell, //投信買賣超
            dealersProprietaryBuy, //自營商(自行買賣)買進金額
    ...
    async onApplicationBootstrap() {
        // const marketTrade = await this.fetchMarketTrades('2023-09-07');
        // console.log(marketTrade); //顯示櫃買市場成交資訊

        // const marketBreadth = await this.fetchMarketBreadth('2023-09-07');
        // console.log(marketBreadth); //顯示櫃買市場上漲及下跌家數

        // const instInvestorsTrades = await this.fetchInstInvestorsTrades('2023-09-07');
        // console.log(instInvestorsTrades); //顯示櫃買市場三大法人買賣金額

        // const marginTransactions = await this.fetchMarginTransactions('2023-09-07');
        // console.log(marginTransactions); //顯示櫃買市場融資融券餘額

        // const indicesQuotes = await this.fetchIndicesQuotes('2023-09-07');
        // console.log(indicesQuotes); //顯示櫃買市場指數行情

        // const indicesTrades = await this.fetchIndicesTrades('2023-09-07');
        // console.log(indicesTrades); //顯示櫃買市場類股成交價量比重

        // const equitiesQuotes = await this.fetchEquitiesQuotes('2023-09-07');
        // console.log(equitiesQuotes); //顯示櫃買市場個股行情

        // const equitiesInstInvestorsTrades = await this.fetchEquitiesInstInvestorsTrades('2023-09-07');
        // console.log(equitiesInstInvestorsTrades); //顯示上櫃股票三大法人買賣明細

        // const equitiesValues = await this.fetchEquitiesValues('2023-09-07');
        // console.log(equitiesValues); //顯示上櫃股票本益比、股價淨值比、殖利率
    }
}
