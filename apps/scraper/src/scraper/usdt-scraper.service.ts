...
@Injectable()
export class UsdtScraperService implements OnApplicationBootstrap {
    ...
    async onApplicationBootstrap() {
        // const usTreasuryYields = await this.fetchUsTreasuryYields('2023-09-07');
        // console.log(usTreasuryYields); //顯示美國公債殖利率
    }
}
