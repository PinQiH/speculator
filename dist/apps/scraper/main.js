...
/***/ "./apps/scraper/src/app.module.ts":
/*!****************************************!*\
  !*** ./apps/scraper/src/app.module.ts ***!
  \****************************************/
...
const scraper_module_1 = __webpack_require__(/*! ./scraper/scraper.module */ "./apps/scraper/src/scraper/scraper.module.ts");
const market_stats_module_1 = __webpack_require__(/*! ./market-stats/market-stats.module */ "./apps/scraper/src/market-stats/market-stats.module.ts");
const ticker_module_1 = __webpack_require__(/*! ./ticker/ticker.module */ "./apps/scraper/src/ticker/ticker.module.ts");
const market_stats_service_1 = __webpack_require__(/*! ./market-stats/market-stats.service */ "./apps/scraper/src/market-stats/market-stats.service.ts");
const ticker_service_1 = __webpack_require__(/*! ./ticker/ticker.service */ "./apps/scraper/src/ticker/ticker.service.ts");
const report_module_1 = __webpack_require__(/*! ./report/report.module */ "./apps/scraper/src/report/report.module.ts");
const report_service_1 = __webpack_require__(/*! ./report/report.service */ "./apps/scraper/src/report/report.service.ts");
let AppModule = AppModule_1 = class AppModule {
    constructor(marketStatsService, tickerService, reportService) {
...
exports.AppModule = AppModule = AppModule_1 = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof market_stats_service_1.MarketStatsService !== "undefined" && market_stats_service_1.MarketStatsService) === "function" ? _a : Object, typeof (_b = typeof ticker_service_1.TickerService !== "undefined" && ticker_service_1.TickerService) === "function" ? _b : Object, typeof (_c = typeof report_service_1.ReportService !== "undefined" && report_service_1.ReportService) === "function" ? _c : Object])
], AppModule);


/***/ }),

/***/ "./apps/scraper/src/market-stats/market-stats.module.ts":
/*!**************************************************************!*\
  !*** ./apps/scraper/src/market-stats/market-stats.module.ts ***!
  \**************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const mongoose_1 = __webpack_require__(/*! @nestjs/mongoose */ "@nestjs/mongoose");
const market_stats_schema_1 = __webpack_require__(/*! ./market-stats.schema */ "./apps/scraper/src/market-stats/market-stats.schema.ts");
const market_stats_repository_1 = __webpack_require__(/*! ./market-stats.repository */ "./apps/scraper/src/market-stats/market-stats.repository.ts");
const market_stats_service_1 = __webpack_require__(/*! ./market-stats.service */ "./apps/scraper/src/market-stats/market-stats.service.ts");
const scraper_module_1 = __webpack_require__(/*! ../scraper/scraper.module */ "./apps/scraper/src/scraper/scraper.module.ts");
...
/***/ "./apps/scraper/src/market-stats/market-stats.repository.ts":
/*!******************************************************************!*\
  !*** ./apps/scraper/src/market-stats/market-stats.repository.ts ***!
  \******************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./apps/scraper/src/market-stats/market-stats.schema.ts":
/*!**************************************************************!*\
  !*** ./apps/scraper/src/market-stats/market-stats.schema.ts ***!
  \**************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./apps/scraper/src/market-stats/market-stats.service.ts":
/*!***************************************************************!*\
  !*** ./apps/scraper/src/market-stats/market-stats.service.ts ***!
  \***************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const schedule_1 = __webpack_require__(/*! @nestjs/schedule */ "@nestjs/schedule");
const market_stats_repository_1 = __webpack_require__(/*! ./market-stats.repository */ "./apps/scraper/src/market-stats/market-stats.repository.ts");
const twse_scraper_service_1 = __webpack_require__(/*! ../scraper/twse-scraper.service */ "./apps/scraper/src/scraper/twse-scraper.service.ts");
const taifex_scraper_service_1 = __webpack_require__(/*! ../scraper/taifex-scraper.service */ "./apps/scraper/src/scraper/taifex-scraper.service.ts");
let MarketStatsService = MarketStatsService_1 = class MarketStatsService {
    ...
    async updateTaiex(date = luxon_1.DateTime.local().toISODate()) {
    ...
    async updateInstInvestorsTrades(date = luxon_1.DateTime.local().toISODate()) {
    ...
    async updateMarginTransactions(date = luxon_1.DateTime.local().toISODate()) {
    ...
    async updateFiniTxfNetOi(date = luxon_1.DateTime.local().toISODate()) {
    ...
    async updateFiniTxoNetOiValue(date = luxon_1.DateTime.local().toISODate()) {
    ...
    async updateLargeTradersTxfNetOi(date = luxon_1.DateTime.local().toISODate()) {
    ...
    async updateRetailMxfPosition(date = luxon_1.DateTime.local().toISODate()) {
    ...
    async updateTxoPutCallRatio(date = luxon_1.DateTime.local().toISODate()) {
    ...
    async updateUsdTwdRate(date = luxon_1.DateTime.local().toISODate()) {
...
/***/ "./apps/scraper/src/report/enums/color.enum.ts":
/*!*****************************************************!*\
  !*** ./apps/scraper/src/report/enums/color.enum.ts ***!
  \*****************************************************/
...
/***/ "./apps/scraper/src/report/enums/index.ts":
/*!************************************************!*\
  !*** ./apps/scraper/src/report/enums/index.ts ***!
  \************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__exportStar(__webpack_require__(/*! ./color.enum */ "./apps/scraper/src/report/enums/color.enum.ts"), exports);


/***/ }),

/***/ "./apps/scraper/src/report/report.module.ts":
/*!**************************************************!*\
  !*** ./apps/scraper/src/report/report.module.ts ***!
  \**************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const market_stats_module_1 = __webpack_require__(/*! ../market-stats/market-stats.module */ "./apps/scraper/src/market-stats/market-stats.module.ts");
const ticker_module_1 = __webpack_require__(/*! ../ticker/ticker.module */ "./apps/scraper/src/ticker/ticker.module.ts");
const report_service_1 = __webpack_require__(/*! ./report.service */ "./apps/scraper/src/report/report.service.ts");
...
/***/ "./apps/scraper/src/report/report.service.ts":
/*!***************************************************!*\
  !*** ./apps/scraper/src/report/report.service.ts ***!
  \***************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const market_stats_repository_1 = __webpack_require__(/*! ../market-stats/market-stats.repository */ "./apps/scraper/src/market-stats/market-stats.repository.ts");
const ticker_repository_1 = __webpack_require__(/*! ../ticker/ticker.repository */ "./apps/scraper/src/ticker/ticker.repository.ts");
const utils_1 = __webpack_require__(/*! ./utils */ "./apps/scraper/src/report/utils/index.ts");
let ReportService = ReportService_1 = class ReportService {
    constructor(mailerService, marketStatsRepository, tickerRepository) {
        this.mailerService = mailerService;
        this.marketStatsRepository = marketStatsRepository;
        this.tickerRepository = tickerRepository;
    }
    async sendReport(options) {
        const dt = options?.date ? luxon_1.DateTime.fromISO(options.date) : luxon_1.DateTime.local();
        ...
        const attachments = [{ filename, content: contentBuffer }];
        await this.mailerService.sendMail({ subject, attachments })
            .then(() => common_1.Logger.log(`"${subject}" 已寄出`, ReportService_1.name))
            .catch((err) => common_1.Logger.error(err.message, err.stack, ReportService_1.name));
    }
...
exports.ReportService = ReportService = ReportService_1 = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [typeof (_a = typeof mailer_1.MailerService !== "undefined" && mailer_1.MailerService) === "function" ? _a : Object, typeof (_b = typeof market_stats_repository_1.MarketStatsRepository !== "undefined" && market_stats_repository_1.MarketStatsRepository) === "function" ? _b : Object, typeof (_c = typeof ticker_repository_1.TickerRepository !== "undefined" && ticker_repository_1.TickerRepository) === "function" ? _c : Object])
], ReportService);


/***/ }),

/***/ "./apps/scraper/src/report/utils/get-font-color-by-net-change.util.ts":
/*!****************************************************************************!*\
  !*** ./apps/scraper/src/report/utils/get-font-color-by-net-change.util.ts ***!
  \****************************************************************************/
...
const enums_1 = __webpack_require__(/*! ../enums */ "./apps/scraper/src/report/enums/index.ts");
...
/***/ "./apps/scraper/src/report/utils/index.ts":
/*!************************************************!*\
  !*** ./apps/scraper/src/report/utils/index.ts ***!
  \************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__exportStar(__webpack_require__(/*! ./get-font-color-by-net-change.util */ "./apps/scraper/src/report/utils/get-font-color-by-net-change.util.ts"), exports);


/***/ }),

/***/ "./apps/scraper/src/scraper/mops-scraper.service.ts":
/*!**********************************************************!*\
  !*** ./apps/scraper/src/scraper/mops-scraper.service.ts ***!
  \**********************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./apps/scraper/src/scraper/scraper.module.ts":
/*!****************************************************!*\
  !*** ./apps/scraper/src/scraper/scraper.module.ts ***!
  \****************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const axios_1 = __webpack_require__(/*! @nestjs/axios */ "@nestjs/axios");
const twse_scraper_service_1 = __webpack_require__(/*! ./twse-scraper.service */ "./apps/scraper/src/scraper/twse-scraper.service.ts");
const tpex_scraper_service_1 = __webpack_require__(/*! ./tpex-scraper.service */ "./apps/scraper/src/scraper/tpex-scraper.service.ts");
const taifex_scraper_service_1 = __webpack_require__(/*! ./taifex-scraper.service */ "./apps/scraper/src/scraper/taifex-scraper.service.ts");
const tdcc_scraper_service_1 = __webpack_require__(/*! ./tdcc-scraper.service */ "./apps/scraper/src/scraper/tdcc-scraper.service.ts");
const mops_scraper_service_1 = __webpack_require__(/*! ./mops-scraper.service */ "./apps/scraper/src/scraper/mops-scraper.service.ts");
const usdt_scraper_service_1 = __webpack_require__(/*! ./usdt-scraper.service */ "./apps/scraper/src/scraper/usdt-scraper.service.ts");
const yahoo_finance_service_1 = __webpack_require__(/*! ./yahoo-finance.service */ "./apps/scraper/src/scraper/yahoo-finance.service.ts");
...
/***/ "./apps/scraper/src/scraper/taifex-scraper.service.ts":
/*!************************************************************!*\
  !*** ./apps/scraper/src/scraper/taifex-scraper.service.ts ***!
  \************************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./apps/scraper/src/scraper/tdcc-scraper.service.ts":
/*!**********************************************************!*\
  !*** ./apps/scraper/src/scraper/tdcc-scraper.service.ts ***!
  \**********************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./apps/scraper/src/scraper/tpex-scraper.service.ts":
/*!**********************************************************!*\
  !*** ./apps/scraper/src/scraper/tpex-scraper.service.ts ***!
  \**********************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./apps/scraper/src/scraper/twse-scraper.service.ts":
/*!**********************************************************!*\
  !*** ./apps/scraper/src/scraper/twse-scraper.service.ts ***!
  \**********************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./apps/scraper/src/scraper/usdt-scraper.service.ts":
/*!**********************************************************!*\
  !*** ./apps/scraper/src/scraper/usdt-scraper.service.ts ***!
  \**********************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./apps/scraper/src/scraper/yahoo-finance.service.ts":
/*!***********************************************************!*\
  !*** ./apps/scraper/src/scraper/yahoo-finance.service.ts ***!
  \***********************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./apps/scraper/src/ticker/ticker.module.ts":
/*!**************************************************!*\
  !*** ./apps/scraper/src/ticker/ticker.module.ts ***!
  \**************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const mongoose_1 = __webpack_require__(/*! @nestjs/mongoose */ "@nestjs/mongoose");
const ticker_schema_1 = __webpack_require__(/*! ./ticker.schema */ "./apps/scraper/src/ticker/ticker.schema.ts");
const ticker_repository_1 = __webpack_require__(/*! ./ticker.repository */ "./apps/scraper/src/ticker/ticker.repository.ts");
const ticker_service_1 = __webpack_require__(/*! ./ticker.service */ "./apps/scraper/src/ticker/ticker.service.ts");
const scraper_module_1 = __webpack_require__(/*! ../scraper/scraper.module */ "./apps/scraper/src/scraper/scraper.module.ts");
...
/***/ "./apps/scraper/src/ticker/ticker.repository.ts":
/*!******************************************************!*\
  !*** ./apps/scraper/src/ticker/ticker.repository.ts ***!
  \******************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
let TickerRepository = class TickerRepository {
    ...
    async getTickerSMAs(symbol, options) {
        const date = options?.date || luxon_1.DateTime.local().toISODate();
        ...
        const sma5 = technicalindicators_1.SMA.calculate({ period: 5, values });
        const sma10 = technicalindicators_1.SMA.calculate({ period: 10, values });
        const sma20 = technicalindicators_1.SMA.calculate({ period: 20, values });
        const sma60 = technicalindicators_1.SMA.calculate({ period: 60, values });
...
/***/ "./apps/scraper/src/ticker/ticker.schema.ts":
/*!**************************************************!*\
  !*** ./apps/scraper/src/ticker/ticker.schema.ts ***!
  \**************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
/***/ "./apps/scraper/src/ticker/ticker.service.ts":
/*!***************************************************!*\
  !*** ./apps/scraper/src/ticker/ticker.service.ts ***!
  \***************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const ticker_repository_1 = __webpack_require__(/*! ./ticker.repository */ "./apps/scraper/src/ticker/ticker.repository.ts");
const twse_scraper_service_1 = __webpack_require__(/*! ../scraper/twse-scraper.service */ "./apps/scraper/src/scraper/twse-scraper.service.ts");
const tpex_scraper_service_1 = __webpack_require__(/*! ../scraper/tpex-scraper.service */ "./apps/scraper/src/scraper/tpex-scraper.service.ts");
...
const app_module_1 = __webpack_require__(/*! ./app.module */ "./apps/scraper/src/app.module.ts");
